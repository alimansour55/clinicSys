...
const ar = {
  ...
  "Age": "العمر",
  "years old": "سنة",
  "Patient record appointments": "المواعيد",
  "Paid appointments": "المدفوعة",
  "Unpaid appointments": "غير المدفوعة",
  "Completed appointments": "المكتملة",
  "Insurance on file": "يوجد تأمين مسجل",
  "Insurance not on file": "لا يوجد تأمين مسجل",
  "Insurance provider label": "مزود التأمين",
  "Insurance full name": "الاسم الكامل",
  "Insurance birth date": "تاريخ الميلاد",
  "Insurance ID number": "رقم الهوية",
  "Insurance expiry date": "تاريخ الانتهاء",
  "View medical card": "عرض البطاقة الطبية",
  "Medical history": "التاريخ الطبي",
  "No clinical notes in profile.": "لا توجد ملاحظات طبية في الملف.",
  "No visits yet.": "لا توجد زيارات حتى الآن.",
  "No insurance captured yet.":
