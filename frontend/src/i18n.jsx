...
const ar = {
  ...
  "Please sign up to book appointment": "يرجى إنشاء حساب لحجز موعد",
  "Please login to book appointment": "يرجى تسجيل الدخول لحجز موعد",
  ...
  "Simplifying healthcare access through smart appointment management. Book your doctor, anytime, anywhere with Clinivo's intelligent scheduling system. No more long waits or booking hassles - just efficient, reliable, and patient-focused healthcare at your convenience.":
    "نُبسّط الوصول إلى الرعاية الصحية من خلال إدارة ذكية للمواعيد. احجز موعدك مع طبيبك في أي وقت ومن أي مكان عبر نظام كلينيفو الذكي لإدارة المواعيد. لا مزيد من الانتظار الطويل أو صعوبات الحجز — فقط رعاية صحية فعّالة وموثوقة تركّز على راحة المريض.",
  ...
  "Medical Booking Assistant": "مساعد الحجز الطبي",
  "Start Chat": "ابدأ الدردشة",
  "Chat with us to book": "ابدأ الدردشة",
  "Online": "متصل",
  "Ask AI": "اسأل المساعد",
  "Type your symptoms or start booking...": "اكتب أعراضك أو ابدأ الحجز...",
