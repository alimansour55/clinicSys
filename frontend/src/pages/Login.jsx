        ...
        {state === 'Sign Up' && (
          <>
            ...
            <div className='mb-4'>
              ...
              <input
                id='signup-dob'
                className='date-field-input w-full min-h-[44px] rounded-md border-2 border-gray-300 px-4 py-2.5 text-sm sm:text-base focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20'
                type='date'
                max={today}
