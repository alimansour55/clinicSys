...
/** Mirrors backend/__tests__/egyptPhone.test.js (T1.1 / T4.1). */
describe('egyptPhone', () => {
  ...
  describe('normalizeEgyptPhone', () => {
    ...
    it.each([
      ...
      ['local 10 digits', '1012345678', validStored],
  ...
  describe('toEgyptLocalDigits', () => {
    it('returns local digits from stored phone', () => {
